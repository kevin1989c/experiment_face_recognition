...
if __name__ == '__main__':
     for train_loop in range(1,17):
        print('face image trainning number%i processing......'%int(train_loop))
        train_opencv(img_h=112,img_w=92,total_image_num=320,person_num=20,datacsv_file='sheffield_train.csv',train_i=train_loop)
